...
4. Créer une classe **PaiementCB** et une classe **PaiementEspece** dérivant de **Paiement** (abstract), qui auront un identifiant de référence, une date ainsi qu’une méthode pour payer.
